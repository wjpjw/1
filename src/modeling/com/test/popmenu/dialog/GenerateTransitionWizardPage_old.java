...
public class GenerateTransitionWizardPage_old extends WizardPage{
	...
	protected GenerateTransitionWizardPage_old(String pageName) {
		super(pageName);
...
//		
	...
	private boolean isInputValid() {
		...
		postState.setName(textPre.getText());
